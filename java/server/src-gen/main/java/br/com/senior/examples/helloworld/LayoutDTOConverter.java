...
import br.com.senior.examples.helloworld.Fielddto;
import br.com.senior.examples.helloworld.FileFormat;
import br.com.senior.examples.helloworld.Hookdto;
import br.com.senior.examples.helloworld.Layoutdto;
...
public final class LayoutDTOConverter {
	...
	public static Layoutdto toDto(Layout layout) {
	    ...
	    dto.errorStrategy = br.com.senior.examples.helloworld.ErrorStrategy.valueOf(layout.getErrorStrategy().name());
	    ...
	    for (Field field : layout.getFields()) {
	        ...
	        fdto.fieldType = br.com.senior.examples.helloworld.FieldType.valueOf(field.getFieldType().name());
	        fdto.id = field.getId();
	    ...
	    if (layout.getHooks() != null) {
	        for (Hook hook : layout.getHooks()) {
	            ...
	            hdto.hookFunction = br.com.senior.examples.helloworld.HookFunction.valueOf(hook.getHookFunction().name());
