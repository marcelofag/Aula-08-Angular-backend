 ...
 * 
 */
public class UpdateMergePedidoImpl {
	...
	public UpdateMergePedidoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Pedido input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				HelloWorldConstants.Commands.UPDATE_MERGE_PEDIDO, //
