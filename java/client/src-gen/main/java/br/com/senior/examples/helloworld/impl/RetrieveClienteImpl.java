 ...
 * 
 */
public class RetrieveClienteImpl {
	...
	public RetrieveClienteImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Cliente.Id input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				HelloWorldConstants.Commands.RETRIEVE_CLIENTE, //
