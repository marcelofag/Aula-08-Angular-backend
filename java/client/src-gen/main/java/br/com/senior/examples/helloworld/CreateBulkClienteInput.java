...
public class CreateBulkClienteInput {
     ...
     */
    public java.util.List<Cliente> entities;
    
    public CreateBulkClienteInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public CreateBulkClienteInput(java.util.List<Cliente> entities) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CreateBulkClienteInput)) {
            return false;
        }
        CreateBulkClienteInput other = (CreateBulkClienteInput) obj;
