 ...
 * 
 */
public class UpdateClienteImpl {
	...
	public UpdateClienteImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
	...
	private Message createMessage(Cliente input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				...
				HelloWorldConstants.Commands.UPDATE_CLIENTE, //
