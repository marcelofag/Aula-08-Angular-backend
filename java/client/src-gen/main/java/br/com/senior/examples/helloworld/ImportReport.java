...
public class ImportReport {
     ...
     */
    public ImportReport(String id, java.util.Date startTime, java.util.Date endTime, String uri, String beanClass, String serviceClass, Layoutdto layout, Long sucessCount, Long errorsCount, Long filteredCount, Long skippedCount, java.util.List<ImportError> importErrors) {
        this.id = id;
     ...
     */
    public ImportReport(String id, java.util.Date startTime, java.util.Date endTime, String uri, String beanClass, String serviceClass, Layoutdto layout, Long sucessCount, Long errorsCount, Long filteredCount, Long skippedCount) {
        this.id = id;
        this.startTime = startTime;
        this.endTime = endTime;
        this.uri = uri;
